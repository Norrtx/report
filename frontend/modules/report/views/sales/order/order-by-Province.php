...
$urlExpand = Url::to(['/report/sales/ajax-order-by-province','datetime_start'=>$datetimestart,'datetime_end'=>$datetimeend ]);
$filledMap = [];
$selectedRegions = [];
...
//     $('#btn').click(function(){
//         var id = $(this).data('id');
//         $.get("$urlExpand" , function(data1, status){
//             $("#world").html(data1);
//         });
//     });
// }); 
                                    ...
                                    <div class="col-sm-4">
                                        <div id="w0-container" class="kv-drp-container ">
                                            <?= DateRangePicker::widget([
                                                'name' => 'date_range_3',
                                                'value' =>$dateend->format('d-m-Y 00:00').' - '.$datenow->format('d-m-Y 23:59'),                               
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="col-lg-4 text-center">
                        ...
                        <div class="m-b-xs">
                            <small class="">ยอดขายแบ่งตามจังหวัด</small>
                        </div>
                        <div class="card-body">
                                ...
                                'columns' => [                                    
                                    ...
                                    [
                                        ...
                                        'formatted' => function ($model) {
                                            return $model['sumtotal1'] < 0 ? 0 :' Total: '.number_format($model['sumtotal1'], 0) . ' THB';
                                        },
                                    ]
                                ],                               
                            ]) ?>
                                            ...
                                            'columns' => [
                                                ...
                                                [
                                                    ...
                                                    'value' =>  function ($model) {
                                                        ...
                                                        // return $model->sumtotal . ' | ' . $model->provinceid;
                                                    },
                                                    'hAlign' => GridView::ALIGN_CENTER,
                                                    'vAlign' => GridView::ALIGN_MIDDLE                                                   
                                                ],
